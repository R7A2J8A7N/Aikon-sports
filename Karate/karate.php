...
<body>
  ...
  <section id="page-header">
    <h2>Karate Uniform & Equipments</h2>
  ...
  <section id="product1" class="section-p1">
    <h2>Karate Uniform</h2>
    <p>Explore Our Exclusive Uniform</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Karate Uniform' LIMIT 8";
  ...
  <section id="product1" class="section-p1">
    ...
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Karate Helmet' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
  ...
  <section id="product1" class="section-p1">
    <h2>Karate Safty Shoes</h2>
    <p>Explore Our Exclusive Uniform</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Karate Safty Shoes' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
