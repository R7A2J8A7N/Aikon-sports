...
<body>
  ...
  <section id="product1" class="section-p1">
    ...
    <div class="pro-container">
      ...
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Judo Uniform' LIMIT 8";
  ...
  <section id="product1" class="section-p1">
    ...
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Judo Helmet' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
  ...
  <section id="product1" class="section-p1">
    <h2>Judo Safty Shoes</h2>
    <p>Explore Our Exclusive Uniform</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Judo Safty Shoes' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
