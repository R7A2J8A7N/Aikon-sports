...
$total_products_row = mysqli_fetch_row($total_products_result);
$total_products = $total_products_row[0];
$total_pages = ceil($total_products / $products_per_page);
$product_query = "SELECT * FROM products LIMIT $products_per_page OFFSET $offset";
...
<body>
  ...
  <footer class="section-p1">
    ...
    <div class="copyright">
      <p>&copy; <span id="currentYear"></span> <b>AIKON SPORTS</b></p>
    </div>
  </footer>
</body>
