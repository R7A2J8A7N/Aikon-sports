...
<body>
  ...
  <section id="page-header">
    <h2>Taekwondo Uniform & Equipments</h2>
  ...
  <section id="product1" class="section-p1">
    <h2>Taekwondo Uniform</h2>
    <p>Explore Our Exclusive Uniform</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Taekwondo Uniform' LIMIT 8";
  ...
  <section id="product1" class="section-p1">
    <h2>Taekwondo Helmet</h2>
    <p>Explore Our Exclusive Helmet</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Taekwondo Helmet' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
  ...
  <section id="product1" class="section-p1">
    <h2>Taekwondo Safty Shoes</h2>
    <p>Explore Our Exclusive Uniform</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Taekwondo Safty Shoes' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
  ...
  <section id="product1" class="section-p1">
    <h2>Taekwondo Protector</h2>
    <p>Explore Our Exclusive Uniform</p>
    <div class="pro-container">
      <?php
      include('../admin/include/config.php');
      $featured_query = "SELECT * FROM products WHERE subcategory = 'Taekwondo Protector' LIMIT 8";
      $featured_result = mysqli_query($conn, $featured_query);
